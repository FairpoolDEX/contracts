...
export async function upgradeContract(context: UpgradeContractContext) {
  const { contractName, contractAddress, ethers, upgrades, log, run } = context
...
function validateUpgradeContractTaskArguments(args: UpgradeContractTaskArguments): UpgradeContractTaskArguments {
